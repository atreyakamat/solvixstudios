        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-24">
          <div className="max-w-2xl">
            ...
            <h2 className="text-5xl font-extrabold tracking-tight text-[var(--foreground)] sm:text-7xl">
              Engineered for <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Results.</span>
            </h2>
            ...
            >
              <Card className="h-full overflow-hidden border-[var(--glass-border)] bg-[var(--glass-bg)] p-3 transition-all duration-500 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-500/10">
                <div className={`h-72 w-full rounded-2xl bg-gradient-to-br ${project.image} relative flex items-center justify-center overflow-hidden`}>
                  ...
                  <span className="text-3xl font-extrabold uppercase tracking-tight text-white/5 group-hover:text-white/20 group-hover:scale-110 transition-all duration-700">
                    {project.client}
                  </span>
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 p-4 shadow-2xl">
                       <span className="block text-xs font-extrabold text-white/60 uppercase tracking-widest mb-1">Key Outcome</span>
                       <span className="text-xl font-extrabold text-white tracking-tight">{project.result}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-6">
                    <span className="rounded-lg bg-purple-500/10 px-3 py-1 text-xs font-extrabold uppercase tracking-widest text-purple-500 border border-purple-500/20">
                      {project.industry}
                    </span>
                  ...
                  <h3 className="text-3xl font-extrabold text-[var(--foreground)] mb-6 tracking-tight">{project.client}</h3>
